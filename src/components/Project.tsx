      ...
      <div className="relative">
        ...
        <div className="relative w-full h-[340px] md:h-[380px] bg-black-900 p-5 sm:p-8 lg:p-12 -mt-2">
          ...
          <div className="w-full">
            <div className="absolute inset-x-5 md:inset-x-12 bottom-10 flex justify-between items-center lg:text-lg">
              <Link
              ...
              {project.codeLink ? (
                <Link
                  ...
                  target="_blank"
                  className="inline-flex items-center sm:font-medium text-md gap-1 sm:gap-2 lg:text-lg text-white cursor-pointer"
                >
                ...
                <div className="inline-flex items-center sm:font-medium text-md gap-1 sm:gap-2 lg:text-lg text-white">
